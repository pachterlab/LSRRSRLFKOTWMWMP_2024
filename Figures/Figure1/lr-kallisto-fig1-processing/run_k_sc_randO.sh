...
output='b01_next1_13G_single_cell_randO' #G_demux' #H.5'
ref='ref/mm39'
...
${path_to_lr_kallisto} bus -x '1,0,24:2,0,10:0,0,0' -i ref/mm39_k-31.idx -o ${output} -t 32 13G_next1_randO_R1.fastq.gz 13G_next1_randO_R2.fastq.gz 13G_next1_randO_umi.fastq.gz
