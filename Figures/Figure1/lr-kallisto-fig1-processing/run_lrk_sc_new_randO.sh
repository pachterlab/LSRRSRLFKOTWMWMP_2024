...
sample='13G_'
output='b01_nanopore_'${sample}'sc_rt_randO_single_cell'

${path_to_lr_kallisto} bus -x ${tech} --long -i ${ref}_k-63.idx -o ${output} -t 32 ${sample}read_rt_randO.fastq.gz ${sample}umi_rt_randO.fastq.gz ${sample}bc_rt_randO.fastq.gz
