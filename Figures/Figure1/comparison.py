...
def comparison(long, short, ref):
        ...
        count = mmread(long+'/matrix.abundance.mtx')
        ...
        y, x = y/np.sum(y)*1000000,x/np.sum(x)*1000000
        ...
        if short.split('_')[1] == 'nanopore':
            ...
            platform2 = 'Illumina'
        plt.xlabel(capture + " " + platform + " log2(TPM)")
        plt.ylabel(capture_2 + " " + platform2 + " log2(TPM)")
...
def comparison_oarfish(long, short, ref):
        ...
        if short.split("_")[2] == '13H':
            ...
            capture_2 = 'exome capture'
        plt.xlabel(capture + " ONT log2(TPM)")
        plt.ylabel(capture_2 + " Illumina log2(TPM)")
...
#comparison("b01_nanopore_13G_mm39_bulk","b01_next1_13G_mm39_bulk", 'C57BL/6J')
#comparison("b01_nanopore_13G_mm39_bulk", "b01_nanopore_13H_mm39_bulk", 'C57BL/6J')
#comparison("b01_next1_13G_mm39_bulk", "b01_next1_13H_mm39_bulk", 'C57BL/6J')
#comparison("b01_nanopore_13H_mm39_bulk", "b01_next1_13G_mm39_bulk", 'C57BL/6J')
#comparison("b01_nanopore_13G_mm39_bulk", "b01_next1_13H_mm39_bulk", 'C57BL/6J')
#comparison("b01_nanopore_13H_mm39_bulk","b01_next1_13H_mm39_bulk", 'C57BL/6J')

comparison("/home/diane/analysis/lrkallisto/b01_nanopore_13H_bulk_k63_mm39/quant_unfiltered","/home/diane/analysis/lrkallisto/b01_next1_13H_bulk_k31_mm39/quant_unfiltered", 'C57BL/6J')
comparison("/home/diane/analysis/lrkallisto/b01_nanopore_13G_bulk_k63_mm39/quant_unfiltered","/home/diane/analysis/lrkallisto/b01_next1_13G_bulk_k31_mm39/quant_unfiltered", 'C57BL/6J')
comparison("/home/diane/analysis/lrkallisto/b01_nanopore_13H_bulk_k63_casteij/quant_unfiltered","/home/diane/analysis/lrkallisto/b01_next1_13H_bulk_k31_casteij/quant_unfiltered", 'CAST/EiJ')
comparison("/home/diane/analysis/lrkallisto/b01_nanopore_13G_bulk_k63_casteij/quant_unfiltered","/home/diane/analysis/lrkallisto/b01_next1_13G_bulk_k31_casteij/quant_unfiltered", 'CAST/EiJ')

comparison_oarfish("b01_nanopore_13H_oarfish.quant", "/home/diane/analysis/lrkallisto/b01_next1_13H_bulk_k31_mm39/quant_unfiltered", 'C57BL/6J')
comparison_oarfish("b01_nanopore_13G_oarfish.quant", "/home/diane/analysis/lrkallisto/b01_next1_13G_bulk_k31_mm39/quant_unfiltered", 'C57BL/6J')
comparison_bambu("b01_nanopore_13G_bambu", "/home/diane/analysis/lrkallisto/b01_next1_13G_bulk_k31_mm39/quant_unfiltered", "C57BL/6J")
comparison_IQ("b01_nanopore_13G_IQ", "/home/diane/analysis/lrkallisto/b01_next1_13G_bulk_k31_mm39/quant_unfiltered", "C57BL/6J")

comparison("b01_nanopore_13H_casteij_bulk","b01_next1_13H_casteij_bulk", 'CAST/EiJ')
comparison("b01_nanopore_13G_casteij_bulk","b01_next1_13G_casteij_bulk", 'CAST/EiJ')
